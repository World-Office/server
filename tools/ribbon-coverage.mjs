...
const WIRING = {
  word: {
    ...
    insertSectionBreak: { target: "wasm", implemented: true },
    pageMargins: { target: "panel", implemented: true },
    pageOrientation: { target: "panel", implemented: true },
    pageSize: { target: "panel", implemented: true },
    removeFooter: { target: "store", implemented: true },
    removeHeader: { target: "store", implemented: true },
    openTheme: { target: "panel", implemented: true },
    lineNumbers: { target: "store", implemented: true },
    hyphenation: { target: "panel", implemented: true },
    wrapping: { target: "panel", implemented: true },
    openBreaksPanel: { target: "panel", implemented: true },
    bringForward: { target: "store", implemented: true },
    sendBackward: { target: "store", implemented: true },
    alignObjects: { target: "store", implemented: true },
    groupObjects: { target: "store", implemented: true },
    mergeShapes: { target: "store", implemented: true },
    watermark: { target: "panel", implemented: true },
    pageColor: { target: "panel", implemented: true },
    documentColors: { target: "panel", implemented: true },
    // references
    addComment: { target: "panel", implemented: true }, insertEndnote: { target: "panel", implemented: true },
    insertFootnote: { target: "panel", implemented: true }, insertIndex: { target: "panel", implemented: true },
 ...
 wordCount: { target: "panel", implemented: true },
    ...
    copyStyle: { target: "router", implemented: true },
    drawSelect: { target: "wasm", implemented: true },
    drawEraser: { target: "wasm", implemented: true },
    wordCount: { target: "store", implemented: true },
    setDocumentLanguage: { target: "store", implemented: true },
