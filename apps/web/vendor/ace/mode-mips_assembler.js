      ...
      this.$rules = {
        start: [
          ...
          { token: "constant.numeric.integer.mips", regex: "\\b(?:\\d+|0(?:x|X)[a-fA-F0-9]+)\\b" },
          {
            ...
            regex: '"',
            push: [
              { token: "punctuation.definition.string.end.mips", regex: '"', next: "pop" },
              { token: "constant.character.escape.mips", regex: '\\\\[rnt\\\\"]' },
          ...
          },
          {
            ...
            regex: "#",
            push: [
              { token: "comment.line.number-sign.mips", regex: "$", next: "pop" },
...
ace.define(
  ...
  (require, exports, module) => {
    ...
    var MIPSAssemblerHighlightRules =
      require("./mips_assembler_highlight_rules").MIPSAssemblerHighlightRules
