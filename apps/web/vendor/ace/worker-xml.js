...
!((e) => {
  ...
  e.console ||
    ...
    (e.define = (t, n, r) => {
      ...
      var i = (n) => e.require(t, n)
      e.require.modules[t] = {
        exports: {},
        factory: function () {
          var t = r.apply(
            this,
            n.slice(0, r.length).map((t) => {
              switch (t) {
                case "require":
                  return i
                case "exports":
  ...
  ace.define("ace/lib/deep_copy", [], (e, t, n) => {
  ...
  ace.define("ace/lib/lang", [], (e, t, n) => {
    ;(t.last = (e) => e[e.length - 1]),
      (t.stringReverse = (e) => e.split("").reverse().join("")),
      (t.stringRepeat = (e, t) => {
        var n = ""
        while (t > 0) {
          t & 1 && (n += e)
    ...
    var r = /^\s\s*/,
      i = /\s\s*$/
    ;(t.stringTrimLeft = (e) => e.replace(r, "")),
      (t.stringTrimRight = (e) => e.replace(i, "")),
      (t.copyObject = (e) => {
        var t = {}
      ...
      (t.escapeRegExp = (e) => e.replace(/([.*+?^${}()|[\]\/\\])/g, "\\$1")),
      (t.escapeHTML = (e) =>
        ("" + e)
          .replace(/&/g, "&#38;")
          .replace(/"/g, "&#34;")
      ...
      (t.deferredCall = (e) => {
        var t = null,
          ...
          r = (e) => (r.cancel(), (t = setTimeout(n, e || 0)), r)
        return (
          (r.schedule = r),
          (r.call = function () {
            return this.cancel(), e(), r
          }),
          (r.cancel = () => (clearTimeout(t), (t = null), r)),
          (r.isPending = () => t),
          r
        )
      }),
      ...
      (t.skipEmptyMatch = (e, t, n) => (n && e.codePointAt(t) > 65535 ? 2 : 1))
  }),
  ace.define("ace/apply_delta", [], (e, t, n) => {
    function r(e, t) {
  ...
  ace.define("ace/lib/event_emitter", [], (e, t, n) => {
    var r = {},
      i = function () {
  ...
  ace.define("ace/range", [], (e, t, n) => {
    ...
    ;(r.fromPoints = (e, t) => new r(e.row, e.column, t.row, t.column)),
      (r.comparePoints = (e, t) => e.row - t.row || e.column - t.column),
      (t.Range = r)
  }),
  ace.define("ace/anchor", [], (e, t, n) => {
    function o(e, t, n) {
    ...
    var r = e("./lib/oop"),
      ...
      a = (() => {
        ...
        return (
          ...
          (e.prototype.clonePos = (e) => ({ row: e.row, column: e.column })),
          (e.prototype.pos = (e, t) => ({ row: e, column: t })),
  ...
  ace.define("ace/worker/mirror", [], (e, t, n) => {
    var r = e("../document").Document,
      ...
      s = (t.Mirror = function (e) {
        ...
        e.on("change", (e) => {
          ...
          if (this.$timeout) return n.schedule(this.$timeout)
          this.onUpdate()
        })
      })
    ;(function () {
  ...
  ace.define("ace/mode/xml/sax", [], (e, t, n) => {
    function d() {}
    function v(e, t, n, r, i) {
      ...
      function o(e) {
        ...
        return t in n
          ? n[t]
          : t.charAt(0) === "#"
            ? s(Number.parseInt(t.substr(1).replace("x", "0x")))
    ...
    function y(e, t, n, r) {
      ...
      while (u--) {
        var a = e[u],
          ...
          c = f.indexOf(":")
        if (c > 0)
          var h = (a.prefix = f.slice(0, c)),
            p = f.slice(c + 1),
            d = h === "xmlns" && p
        else (p = f), (h = null), (d = f === "xmlns" && "")
        ;(a.localName = p),
          d !== !1 &&
            (s == null && ((s = {}), E(o, (o = {}))),
            (o[d] = s[d] = l),
      ...
      while (u--) {
        ...
        var h = a.prefix
        h &&
          (h === "xml" && (a.uri = "http://www.w3.org/XML/1998/namespace"),
          h !== "xmlns" && (a.uri = o[h]))
      }
      var c = i.indexOf(":")
      c > 0
        ? ((h = e.prefix = i.slice(0, c)), (p = e.localName = i.slice(c + 1)))
        : ((h = null), (p = e.localName = i))
      var v = (e.uri = o[h || ""])
      h && !v && r.error("unexpected namespace " + h), t.startElement(v, p, i, e)
      if (e.closed) {
        t.endElement(v, p, i)
        if (s) for (h in s) t.endPrefixMapping(h)
      } else (e.currentNSMap = o), (e.localNSMap = s), n.push(e)
    }
  ...
  ace.define("ace/mode/xml/dom", [], (e, t, n) => {
    function r(e, t) {
      for (var n in e) t[n] = e[n]
    }
    function i(e, t) {
    ...
    ;(B.prototype = Error.prototype),
      ...
      i(ht, X),
      (pt.prototype.serializeToString = (e) => {
        var t = []
  ...
  ace.define("ace/mode/xml/dom-parser", [], (e, t, n) => {
    function s(e) {
  ...
  ace.define("ace/mode/xml_worker", [], (e, t, n) => {
    var r = e("../lib/oop"),
      i = e("../lib/lang"),
