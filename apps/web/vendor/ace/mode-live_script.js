        ...
        start: [
          {
            ...
            regex: "\\/\\*",
            push: [
              { token: "punctuation.definition.comment.livescript", regex: "\\*\\/", next: "pop" },
              { token: "storage.type.annotation.livescriptscript", regex: "@\\w*" },
          ...
          },
          {
            ...
            regex: "'''",
            push: [
              { token: "punctuation.definition.string.end.livescript", regex: "'''", next: "pop" },
          ...
          },
          {
            ...
            push: [
              { token: "punctuation.definition.string.end.livescript", regex: '"""', next: "pop" },
              { token: "constant.character.escape.livescript", regex: "\\\\." },
          ...
          },
          {
            ...
            regex: "<\\[",
            push: [
              { token: "string.array-literal.livescript", regex: "\\]>", next: "pop" },
          ...
          },
          {
            ...
            regex: "/{2}$",
            push: [
              { token: "string.regexp.livescript", regex: "/{2}[imgy]{0,4}", next: "pop" },
          ...
          },
          {
            ...
            originalRegex: "(?<=\\s|^)([\\[\\{])(?=.*?[\\]\\}]\\s+[:=])",
            push: [
              { token: "keyword.operator.livescript", regex: "[\\]\\}]\\s*[:=]", next: "pop" },
        ...
        "#interpolated_livescript": [
          {
            todo: {
              ...
              regex: "\\#\\{",
              push: [
                { token: "punctuation.section.embedded.livescript", regex: "\\}", next: "pop" },
                { include: "$self" },
          ...
          },
          {
            todo: {
              ...
              regex: "\\#",
              push: [
                { token: "source.livescript.embedded.source.simple", regex: "", next: "pop" },
                { include: "$self" },
