/** Paragraph settings panel for PDF editor. */
  ...
  return (
    <div className="pdf-properties-panel" style={p.panel}>
      ...
      <div style={p.body}>
        ...
        <div style={p.sec}>
          <div style={p.label}>Indentation</div>
            ...
            <div style={{ flex: 1 }}>
              <label style={p.sm}>
                ...
                <input
                  ...
                  defaultValue={0}
                  min={0}
                  onChange={(e) => cmd("paraIndentLeft", e.target.value)}
                  style={p.inp}
                />
              </label>
            </div>
            <div style={{ flex: 1 }}>
              <label style={p.sm}>
                ...
                <input
                  ...
                  defaultValue={0}
                  min={0}
                  onChange={(e) => cmd("paraIndentRight", e.target.value)}
                  style={p.inp}
                />
              </label>
            </div>
          ...
          <label style={p.sm}>
            Special
            <select onChange={(e) => cmd("paraIndentSpecial", e.target.value)} style={p.sel}>
        ...
        <div style={p.sec}>
          ...
          <label style={p.sm}>
            Line spacing
            <select onChange={(e) => cmd("paraLineSpacing", e.target.value)} style={p.sel}>
