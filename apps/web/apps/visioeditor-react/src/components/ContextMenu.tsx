...
import { exportFlowchartAsPdf, exportFlowchartAsPng, exportFlowchartAsSvg } from "./FlowchartCanvas"
  ...
  if (submenu === "theme") {
    return (
      <div ref={ref} className="fc-context-menu" style={{ left: state.x, top: state.y }}>
        ...
        <button type="button" className="fc-context-item" onClick={() => setSubmenu(null)}>
          Back
        </button>
      </div>
    )
    ...
    <div ref={ref} className="fc-context-menu" style={{ left: state.x, top: state.y }}>
      {state.type === "node" && (
        <>
          ...
          {multiSelected && (
            <>
              <div className="fc-context-sep" />
              <button type="button" className="fc-context-item" onClick={() => setSubmenu("align")}>
                Align &rarr;
              </button>
            </>
          )}
      ...
      {state.type === "background" && (
        <>
          ...
          <div className="fc-context-sep" />
          <button type="button" className="fc-context-item" onClick={() => setSubmenu("theme")}>
            Theme &rarr;
          </button>
          <div className="fc-context-sep" />
          <button
