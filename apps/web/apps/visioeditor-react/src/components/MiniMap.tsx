...
export const MiniMap = observer(function MiniMap({ containerWidth, containerHeight }: { containerWidth: number; containerHeight: number }): JSX.Element | null {
  ...
  }, [store.canvasOffset.x, store.canvasOffset.y, containerWidth, containerHeight, scale, tx, ty])
