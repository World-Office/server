/** Image settings panel for presentation editor. */
	...
	return (
		<div className="prese-properties-panel" style={p.panel}>
			...
			<div style={p.body}>
				...
				<div style={p.sec}>
					<div style={p.label}>Position</div>
					<div style={{ display: "flex", gap: 8 }}>
						<div style={{ flex: 1 }}>
							<label style={p.sm}>
								X
								<input
									type="number"
									defaultValue={100}
									onChange={(e) => cmd("imageX", e.target.value)}
									style={p.inp}
								/>
							</label>
						</div>
						<div style={{ flex: 1 }}>
							<label style={p.sm}>
								...
								<input
									type="number"
									defaultValue={100}
									onChange={(e) => cmd("imageY", e.target.value)}
									style={p.inp}
								/>
							</label>
						</div>
				...
				<div style={p.sec}>
					<div style={p.label}>Rotation</div>
					<input
						type="number"
						defaultValue={0}
						min={-180}
						max={180}
						onChange={(e) => cmd("imageRotation", e.target.value)}
						style={p.inp}
					/>
				</div>
			</div>
