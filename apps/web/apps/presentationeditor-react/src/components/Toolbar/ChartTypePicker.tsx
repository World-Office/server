...
const chartTypes: { type: ChartType; label: string; icon: JSX.Element }[] = [
  {
    ...
    label: "Bar",
    icon: (
      <svg width="32" height="24" viewBox="0 0 32 24" role="img" aria-label="Bar chart">
  ...
  },
  {
    ...
    label: "Column",
    icon: (
      <svg width="32" height="24" viewBox="0 0 32 24" role="img" aria-label="Column chart">
  ...
  },
  {
    ...
    label: "Line",
    icon: (
      <svg width="32" height="24" viewBox="0 0 32 24" role="img" aria-label="Line chart">
  ...
  },
  {
    ...
    label: "Pie",
    icon: (
      <svg width="32" height="24" viewBox="0 0 32 24" role="img" aria-label="Pie chart">
  ...
  },
  {
    ...
    label: "Doughnut",
    icon: (
      <svg width="32" height="24" viewBox="0 0 32 24" role="img" aria-label="Doughnut chart">
      ...
      {open && (
        ...
        >
          {chartTypes.map((ct) => (
            ...
            >
              {ct.icon}
              <span style={{ fontSize: "11px", marginTop: "4px" }}>{ct.label}</span>
            </button>
          ))}
        </div>
      )}
