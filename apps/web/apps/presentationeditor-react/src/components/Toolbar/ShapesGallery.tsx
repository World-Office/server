...
const SHAPES: ShapeOption[] = [
  {
    ...
    label: "Rectangle",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Rectangle">
  ...
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Rounded Rectangle">
  ...
  },
  {
    ...
    label: "Ellipse",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Ellipse">
        <title>Ellipse</title>
        <ellipse cx="16" cy="16" rx="13" ry="9" fill="#4472C4" stroke="#2B5797" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
    ...
    label: "Triangle",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Triangle">
        <title>Triangle</title>
        <polygon points="16,5 29,27 3,27" fill="#4472C4" stroke="#2B5797" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
    ...
    label: "Diamond",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Diamond">
        <title>Diamond</title>
        <polygon points="16,4 28,16 16,28 4,16" fill="#4472C4" stroke="#2B5797" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
    ...
    label: "Line",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Line">
        <title>Line</title>
  ...
  },
  {
    ...
    label: "Arrow",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Arrow">
        <title>Arrow</title>
        <defs>
          <marker id="sg-arr" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto">
  ...
  },
  {
    ...
    label: "Text Box",
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="Text Box">
