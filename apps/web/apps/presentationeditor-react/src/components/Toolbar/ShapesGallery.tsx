...
const SHAPES: ShapeOption[] = [
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32">
        <rect x="4" y="8" width="24" height="16" fill="#4472C4" stroke="#2B5797" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32">
        <rect x="4" y="8" width="24" height="16" rx="4" fill="#4472C4" stroke="#2B5797" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32">
        ...
        <line x1="4" y1="16" x2="24" y2="16" stroke="#333" strokeWidth="2" markerEnd="url(#sg-arr)" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32">
        <rect x="4" y="8" width="24" height="16" fill="white" stroke="#333" strokeWidth="1.5" strokeDasharray="2" />
        <text x="16" y="19" textAnchor="middle" fontSize="10" fill="#333">T</text>
      </svg>
    ),
  },
]
        ...
        >
          {SHAPES.map((s) => (
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#66afe9"; e.currentTarget.style.backgroundColor = "#f0f0f0" }}
