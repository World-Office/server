...
export function FileMenu() {
  ...
  const handleExport = useCallback(async (format: ExportFormat): Promise<boolean> => {
    try {
      ...
      const { CONVERSION_API_URL, downloadBlob: dlBlob } = await import("../../lib/export-service")
  ...
  return (
    <div className={styles.fileMenu}>
      <div className={styles.fileMenuList} role="menubar" aria-label="File menu">
        <FileMenuItems onMenuClick={handleMenuClick} onBack={handleBack} />
      </div>
      <div className={styles.panelContainer}>
        <div className={styles.contentBoxBase}>
