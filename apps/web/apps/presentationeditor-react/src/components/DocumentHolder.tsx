...
export const DocumentHolder = observer(function DocumentHolder() {
  ...
  const handleChange = (next: string) => {
    ...
    if (!presentationStore.wopiFileId || !presentationStore.wopiAccessToken) return
    if (saveTimerRef.current) clearTimeout(saveTimerRef.current)
  ...
  if (presentationStore.isLoadingError) {
    return (
      <div className="prese-document-holder prese-document-holder--error">
        ...
        <button type="button" onClick={() => void presentationStore.loadFromWopi()}>
          Retry
        </button>
      </div>
    )
      ...
      >
        {hasCanvas && (
          <button
            ...
            style={{
              ...
              backgroundColor: effectiveViewMode === "canvas" ? "#fff" : "transparent",
        ...
        {hasHtml && (
          <button
            ...
            style={{
              ...
              backgroundColor: effectiveViewMode === "text" ? "#fff" : "transparent",
              border: "1px solid #ccc",
              borderRadius: 4,
              cursor: "pointer",
            }}
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: effectiveViewMode === "source" ? "#fff" : "transparent",
            border: "1px solid #ccc",
            borderRadius: 4,
            cursor: "pointer",
          }}
