...
const SLIDE_BULLETS: string[][] = [
  ["Welcome to World Office", "A modern document editing suite", "Built with Rust and TypeScript"],
  [
  ...
  ["Questions?", "Contact: team@world-office.org", "Source: codeberg.org/World-Office/server"],
]
