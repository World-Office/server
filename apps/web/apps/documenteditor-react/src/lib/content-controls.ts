  ...
  renderHTML({ HTMLAttributes, node }) {
    ...
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        ...
        style:
          "border: 1px solid #999; padding: 2px 4px; display: inline-block; min-width: 80px; cursor: pointer;",
      }),
      placeholder,
    ]
  },
  ...
  renderHTML({ HTMLAttributes, node }) {
    ...
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        ...
        style:
          "display: inline-block; width: 16px; height: 16px; border: 1px solid #999; vertical-align: middle; cursor: pointer;",
      }),
      checked ? "☑" : "☐",
    ]
  },
  ...
  renderHTML({ HTMLAttributes, node }) {
    ...
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        ...
        contenteditable: "false",
        style:
          "border-bottom: 1px dotted #999; padding: 0 4px; display: inline-block; min-width: 100px; cursor: pointer;",
      }),
      value,
    ]
  },
