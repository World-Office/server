/** TextArt settings panel for spreadsheet editor. */
...
export function TextArtSettingsPanel({ visible }: Props): JSX.Element | null {
	...
	return (
		<div className="se-properties-panel" style={p.panel}>
			<div style={p.header}>TextArt Settings</div>
			<div style={p.body}>
				<div style={p.sec}>
