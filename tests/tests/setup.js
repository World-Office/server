...
const config = {
  ...
  documentServerJwtSecret:
    process.env.DOCUMENT_SERVER_JWT_SECRET || "test_ds_jwt_secret_placeholder",

  // Timeouts (in milliseconds)
  healthCheckTimeout: Number.parseInt(process.env.HEALTH_CHECK_TIMEOUT) || 120000,
  globalTimeout: Number.parseInt(process.env.GLOBAL_TIMEOUT) || 600000,
  healthCheckRetries: Number.parseInt(process.env.HEALTH_CHECK_RETRIES) || 30,
  healthCheckInterval: Number.parseInt(process.env.HEALTH_CHECK_INTERVAL) || 10000,
