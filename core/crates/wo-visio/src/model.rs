...
pub enum GeoSegment {
    MoveTo { x: f64, y: f64 },
    LineTo { x: f64, y: f64 },
    ArcTo { x: f64, y: f64, a: f64, b: f64, c: f64 },
    EllipticalArcTo { x: f64, y: f64, a: f64, b: f64, c: f64, d: f64 },
    NURBSTo { x: f64, y: f64, knots: Vec<f64>, weights: Vec<f64> },
    PolylineTo { x: f64, y: f64, points: Vec<(f64, f64)> },
    BezierTo { x: f64, y: f64, a: f64, b: f64, c: f64, d: f64 },
    SplineStart { x: f64, y: f64, degree: u32, knots: Vec<f64> },
