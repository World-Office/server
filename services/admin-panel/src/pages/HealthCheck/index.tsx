  ...
  return (
    <div>
      ...
      {!loading && data && data.length === 0 && (
        <div style={{ border: '1px solid var(--wo-gray-200)', borderRadius: 8, padding: '2rem', backgroundColor: 'white', textAlign: 'center', color: 'var(--wo-gray-500)' }}>
          ...
          {data.map((svc) => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                ...
                <span
                  style={{
                    ...
                    fontSize: '0.75rem',
                    fontWeight: 600,
                    backgroundColor: svc.status === 'healthy' ? 'var(--wo-green-50)' : 'var(--wo-red-50)',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--wo-gray-500)', marginBottom: '0.125rem' }}>Last Check</div>
                  <div style={{ fontSize: '0.875rem' }}>{svc.lastCheck}</div>
                </div>
                <div>
                  <div style={{ fontSize: '0.75rem', color: 'var(--wo-gray-500)', marginBottom: '0.125rem' }}>Response Time</div>
