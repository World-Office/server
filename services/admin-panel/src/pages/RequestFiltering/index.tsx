...
export function RequestFiltering() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1.5rem' }}>Request Filtering</h2>

      <div style={sectionStyle}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>URL Allowlist</h3>
      ...
      <div style={sectionStyle}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>URL Blocklist</h3>
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <input
            type="text"
            value={newBlockUrl}
      ...
      <div style={sectionStyle}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Allowed HTTP Methods</h3>
          ...
          {ALL_METHODS.map((method) => (
            <label
              ...
              style={{
                ...
                border: '1px solid var(--wo-gray-300)',
                borderRadius: 6,
                backgroundColor: form.allowedMethods.includes(method) ? 'var(--wo-blue-50)' : 'transparent',
                cursor: 'pointer',
              }}
            >
              <input
      ...
      <div style={sectionStyle}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.75rem' }}>Max Request Size</h3>
        <div>
          ...
          <input
            ...
            onChange={(e) => setForm((prev) => ({ ...prev, maxRequestSizeBytes: Number(e.target.value) }))}
            min={1}
            style={inputStyle}
          />
