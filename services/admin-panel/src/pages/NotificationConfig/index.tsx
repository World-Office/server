...
export function NotificationConfig() {
  ...
  const updateSection = <K extends keyof NotificationConfig>(section: K, field: string, value: unknown) => {
    if (!form) return;
    setForm({
      ...form,
  ...
  return (
    <div>
      <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1.5rem' }}>Notification Configuration</h2>
      ...
      <div style={sectionStyle}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '1rem' }}>Push Notifications</h3>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
        ...
        {testMsg && (
          <span style={{ fontSize: '0.875rem', color: testMsg.includes('success') ? 'var(--wo-green-500)' : 'var(--wo-red-500)' }}>
            {testMsg}
          </span>
        )}
      </div>
