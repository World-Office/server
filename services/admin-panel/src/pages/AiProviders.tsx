      ...
      {showForm && (
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, marginBottom: '0.375rem', color: 'var(--wo-gray-500)' }}>
                Name
              </label>
              <input
                type="text"
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
            <button
              ...
              style={{
                ...
                borderRadius: 6,
                backgroundColor:
                  saving || !form.name || !form.apiUrl ? 'var(--wo-gray-300)' : 'var(--wo-blue-500)',
                color: 'white',
                fontSize: '0.875rem',
                fontWeight: 600,
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                ...
                >
                  ...
                  <th style={{ padding: '0.75rem 1rem', textAlign: 'right', fontSize: '0.75rem', textTransform: 'uppercase', color: 'var(--wo-gray-500)' }}>
                    Actions
                  </th>
                </tr>
              </thead>
