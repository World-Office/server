...
export function SecuritySettings() {
  ...
  const updateNested = <K extends keyof SecuritySettings>(
    section: K,
    field: string,
    value: unknown,
  ) => {
        ...
        <div style={{ display: "flex", gap: "1.5rem", marginTop: "0.75rem", flexWrap: "wrap" }}>
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateNested("passwordPolicy", "requireSpecialChars", e.target.checked)
              }
            />
            Special Characters
          </label>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateNested("rateLimiting", "windowSeconds", Number(e.target.value))
              }
              min={1}
              style={inputStyle}
            />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateNested("bruteForceProtection", "maxAttempts", Number(e.target.value))
              }
              min={1}
              style={inputStyle}
            />
