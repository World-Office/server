 ...
 * Migrated from apps/web/apps/common/main/lib/util/define.js
 */

export const MathMainType = {
  Symbol: 0x00,
  Fraction: 0x01,
  Script: 0x02,
  Radical: 0x03,
...
export type MathMainType = (typeof MathMainType)[keyof typeof MathMainType]
...
export const chartLabels = {
  ...
  LineSpark: "Line",
  ColumnSpark: "Column",
  WinLossSpark: "Win/Loss",
  Combo: "Combo",
  BarNormal: "Clustered column",
  BarStacked: "Stacked column",
  BarStackedPer: "100% Stacked column",
  BarNormal3d: "3-D Clustered column",
  BarStacked3d: "3-D Stacked column",
  BarStackedPer3d: "3-D 100% Stacked column",
  BarNormal3dPerspective: "3-D column",
  LineStacked: "Stacked line",
  LineStackedPer: "100% Stacked line",
  LineMarker: "Line with markers",
  LineStackedMarker: "Stacked line with markers",
  LineStackedPerMarker: "100% Stacked line with markers",
  Line3d: "3-D line",
  Doughnut: "Doughnut",
  Pie3d: "3-D pie",
  HBarNormal: "Clustered bar",
  HBarStacked: "Stacked bar",
  HBarStackedPer: "100% Stacked bar",
  HBarNormal3d: "3-D Clustered bar",
  HBarStacked3d: "3-D Stacked bar",
  HBarStackedPer3d: "3-D 100% Stacked bar",
  AreaStacked: "Stacked area",
  AreaStackedPer: "100% Stacked area",
  Scatter: "Scatter",
  ScatterSmoothMarker: "Scatter with smooth lines and markers",
  ScatterSmooth: "Scatter with smooth lines",
  ScatterLineMarker: "Scatter with straight lines and markers",
  ScatterLine: "Scatter with straight lines",
  ComboBarLine: "Clustered column - line",
  ComboBarLineSecondary: "Clustered column - line on secondary axis",
  ComboAreaBar: "Stacked area - clustered column",
  ComboCustom: "Custom combination",
  Radar: "Radar",
  RadarMarker: "Radar with markers",
  RadarFilled: "Filled radar",
} as const

export type ChartLabel = (typeof chartLabels)[keyof typeof chartLabels]

/**
 * SmartArt type display labels.
 * Migrated from apps/web/apps/common/main/lib/util/define.js
 */

export const smartArtLabels = {
  List: "List",
  Process: "Process",
  Cycle: "Cycle",
  Hierarchy: "Hierarchy",
  ...
  AlternatingHexagons: "Alternating Hexagons",
  PictureCaptionList: "Picture Caption List",
  LinedList: "Lined List",
  VerticalBulletList: "Vertical Bullet List",
  VerticalBoxList: "Vertical Box List",
  HorizontalBulletList: "Horizontal Bullet List",
  SquareAccentList: "Square Accent List",
  PictureAccentList: "Picture Accent List",
  BendingPictureAccentList: "Bending Picture Accent List",
  StackedList: "Stacked List",
  IncreasingCircleProcess: "Increasing Circle Process",
  PieProcess: "Pie Process",
  DetailedProcess: "Detailed Process",
  GroupedList: "Grouped List",
  HorizontalPictureList: "Horizontal Picture List",
  ContinuousPictureList: "Continuous Picture List",
  PictureStrips: "Picture Strips",
  VerticalPictureList: "Vertical Picture List",
  AlternatingPictureBlocks: "Alternating Picture Blocks",
  VerticalPictureAccentList: "Vertical Picture Accent List",
  TitledPictureAccentList: "Titled Picture Accent List",
  VerticalBlockList: "Vertical Block List",
  VerticalChevronList: "Vertical Chevron List",
  VerticalAccentList: "Vertical Accent List",
  VerticalArrowList: "Vertical Arrow List",
  TrapezoidList: "Trapezoid List",
  DescendingBlockList: "Descending Block List",
  TableList: "Table List",
  SegmentedProcess: "Segmented Process",
  VerticalCurvedList: "Vertical Curved List",
  PyramidList: "Pyramid List",
  TargetList: "Target List",
  HierarchyList: "Hierarchy List",
  VerticalCircleList: "Vertical Circle List",
  TableHierarchy: "Table Hierarchy",
  BasicProcess: "Basic Process",
  StepUpProcess: "Step Up Process",
  StepDownProcess: "Step Down Process",
  AccentProcess: "Accent Process",
  PictureAccentProcess: "Picture Accent Process",
  AlternatingFlow: "Alternating Flow",
  ContinuousBlockProcess: "Continuous Block Process",
  IncreasingArrowProcess: "Increasing Arrow Process",
  ContinuousArrowProcess: "Continuous Arrow Process",
  ProcessArrows: "Process Arrows",
  CircleAccentTimeline: "Circle Accent Timeline",
  BasicTimeline: "Basic Timeline",
  BasicChevronProcess: "Basic Chevron Process",
  ClosedChevronProcess: "Closed Chevron Process",
  ...
  VerticalProcess: "Vertical Process",
  StaggeredProcess: "Staggered Process",
  ProcessList: "Process List",
  CircleArrowProcess: "Circle Arrow Process",
  BasicBendingProcess: "Basic Bending Process",
  RepeatingBendingProcess: "Repeating Bending Process",
  VerticalBendingProcess: "Vertical Bending Process",
  AscendingPictureAccentProcess: "Ascending Picture Accent Process",
  UpwardArrow: "Upward Arrow",
  DescendingProcess: "Descending Process",
  CircularBendingProcess: "Circular Bending Process",
  Equation: "Equation",
  VerticalEquation: "Vertical Equation",
  Funnel: "Funnel",
  Gear: "Gear",
  ArrowRibbon: "Arrow Ribbon",
  OpposingArrows: "Opposing Arrows",
  ConvergingArrows: "Converging Arrows",
  DivergingArrows: "Diverging Arrows",
  BasicCycle: "Basic Cycle",
  TextCycle: "Text Cycle",
  BlockCycle: "Block Cycle",
  NondirectionalCycle: "Nondirectional Cycle",
  ContinuousCycle: "Continuous Cycle",
  MultidirectionalCycle: "Multidirectional Cycle",
  SegmentedCycle: "Segmented Cycle",
  BasicPie: "Basic Pie",
  RadialCycle: "Radial Cycle",
  BasicRadial: "Basic Radial",
  DivergingRadial: "Diverging Radial",
  RadialVenn: "Radial Venn",
  CycleMatrix: "Cycle Matrix",
  RadialCluster: "Radial Cluster",
  OrganizationChart: "Organization Chart",
  NameAndTitleOrganizationChart: "Name and Title Organization Chart",
  HalfCircleOrganizationChart: "Half Circle Organization Chart",
  CirclePictureHierarchy: "Circle Picture Hierarchy",
  LabeledHierarchy: "Labeled Hierarchy",
  HorizontalOrganizationChart: "Horizontal Organization Chart",
  HorizontalMultiLevelHierarchy: "Horizontal Multi-Level Hierarchy",
  HorizontalHierarchy: "Horizontal Hierarchy",
  HorizontalLabeledHierarchy: "Horizontal Labeled Hierarchy",
  Balance: "Balance",
  CircleRelationship: "Circle Relationship",
  HexagonCluster: "Hexagon Cluster",
  OpposingIdeas: "Opposing Ideas",
  PlusAndMinus: "Plus and Minus",
  ReverseList: "Reverse List",
  CounterbalanceArrows: "Counterbalance Arrows",
  SegmentedPyramid: "Segmented Pyramid",
  NestedTarget: "Nested Target",
  ConvergingRadial: "Converging Radial",
  RadialList: "Radial List",
  ...
  AccentedPicture: "Accented Picture",
  CircularPictureCallout: "Circular Picture Callout",
  SnapshotPictureList: "Snapshot Picture List",
  SpiralPicture: "Spiral Picture",
  CaptionedPictures: "Captioned Pictures",
  BendingPictureCaption: "Bending Picture Caption",
  BendingPictureSemiTranparentText: "Bending Picture Semi-Tranparent Text",
  BendingPictureBlocks: "Bending Picture Blocks",
  BendingPictureCaptionList: "Bending Picture Caption List",
  TitledPictureBlocks: "Titled Picture Blocks",
  PictureGrid: "Picture Grid",
  PictureAccentBlocks: "Picture Accent Blocks",
  AlternatingPictureCircles: "Alternating Picture Circles",
  TitlePictureLineup: "Title Picture Lineup",
  PictureLineup: "Picture Lineup",
  FramedTextPicture: "Framed Text Picture",
  BubblePictureList: "Bubble Picture List",
  Other: "Other",
  PictureOrganizationChart: "Picture Organization Chart",
  ChevronAccentProcess: "Chevron Accent Process",
  RadialPictureList: "Radial Picture List",
  VerticalBracketList: "Vertical Bracket List",
  InterconnectedBlockProcess: "Interconnected Block Process",
  TabbedArc: "Tabbed Arc",
  ThemePictureAccent: "Theme Picture Accent",
  VaryingWidthList: "Varying Width List",
  ConvergingText: "Converging Text",
  InterconnectedRings: "Interconnected Rings",
  ArchitectureLayout: "Architecture Layout",
  ThemePictureAlternatingAccent: "Theme Picture Alternating Accent",
  ThemePictureGrid: "Theme Picture Grid",
  CircleProcess: "Circle Process",
  HexagonRadial: "Hexagon Radial",
  PictureFrame: "PictureFrame",
  TabList: "Tab List",
} as const

export type SmartArtLabel = (typeof smartArtLabels)[keyof typeof smartArtLabels]
