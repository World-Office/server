          ...
          controls: [
            {
              ...
              onChange: (val: string) =>
                window.dispatchEvent(
                  new CustomEvent("wo-command", { detail: { command: "setZoom", value: val } }),
                ),
            },
            {
              id: "fit-page",
      ...
      groups: [
        {
          ...
          controls: [
            ...
            },
            {
              ...
              icon: "Shapes",
              label: "Shape Comment",
              command: "annotationShapeComment",
              toggleable: true,
            },
          ],
        },
          ...
          controls: [
            {
              ...
              toggleable: true,
              tooltip: "Apply all marked redactions",
            },
          ],
        },
        {
              ...
              onChange: (checked: boolean) =>
                window.dispatchEvent(
                  new CustomEvent("wo-command", {
                    detail: { command: "toggleCompactToolbar", value: String(!checked) },
                  }),
                ),
            },
            {
              ...
              onChange: (checked: boolean) =>
                window.dispatchEvent(
                  new CustomEvent("wo-command", {
                    detail: { command: "toggleStatusbar", value: String(checked) },
                  }),
                ),
            },
            {
              ...
              onChange: (checked: boolean) =>
                window.dispatchEvent(
                  new CustomEvent("wo-command", {
                    detail: { command: "toggleLeftPanel", value: String(checked) },
                  }),
                ),
            },
            {
              ...
              onChange: (checked: boolean) =>
                window.dispatchEvent(
                  new CustomEvent("wo-command", {
                    detail: { command: "toggleRightPanel", value: String(checked) },
                  }),
                ),
            },
          ],
