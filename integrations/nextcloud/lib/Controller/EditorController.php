...
use OCA\WorldOffice\DocumentService;
use OCA\WorldOffice\EmailManager;
use OCA\WorldOffice\FileUtility;
use OCA\WorldOffice\FileVersions;
use OCA\WorldOffice\KeyManager;
use OCA\WorldOffice\TemplateManager;
...
class EditorController extends Controller {
    ...
    private function getFileIdByLink(string $link): array {
        ...
        if (preg_match('/\/(files|f|world-office)\/(\d+)/', $parsedLink, $matches)) {
